...
const register =()=>{
    axios.post(`https://realchatapps.herokuapp.com/user/register`,{data:JSON.stringify(inputs)},
    {
        headers: {
   ...
   //      withCredentials: true 
    ...
    return ( 
        ...
        <div className='row'  >
              ...
              <div className='col-10 col-md-6 col-lg-4' style={{padding:"20px",marginTop:"20%"}}>
